...
function ScoreArc({ score }: { score: number }) {
  ...
  return (
    <svg width="128" height="128" viewBox="0 0 128 128">
      ...
      />
      <text x={cx} y={cy - 6} textAnchor="middle" fontSize="24" fontWeight="900" fill={color} fontFamily="-apple-system, sans-serif">
        {score}
      </text>
      ...
      <div style={{ padding: '1.5rem', paddingBottom: '6rem' }}>
        ...
        <div style={{
          ...
          <div style={{ position: 'relative', zIndex: 1 }}>
            ...
            <div style={{ display: 'flex', gap: '1rem', marginBottom: '1.5rem', flexWrap: 'wrap' }}>
              <div style={{ fontSize: '0.875rem', color: '#f59e0b', fontWeight: '700' }}>
                US${goldValueUsd.toFixed(2)}
              </div>
              <div style={{ fontSize: '0.875rem', color: 'rgba(255,255,255,0.55)', fontWeight: '600' }}>
                ZiG {zigBalance.toLocaleString('en', { maximumFractionDigits: 2 })}
              </div>
              {usdBalance > 0 && (
                <div style={{ fontSize: '0.875rem', color: 'rgba(255,255,255,0.45)', fontWeight: '600' }}>
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div>
              <div style={{ fontSize: '0.72rem', fontWeight: '700', color: '#78716c', textTransform: 'uppercase', letterSpacing: '0.06em' }}>
                ZiG Performance
              </div>
        ...
        <div style={{
          ...
          <div style={{ fontSize: '0.72rem', fontWeight: '700', color: '#78716c', textTransform: 'uppercase', letterSpacing: '0.06em', marginBottom: '1rem' }}>
        ...
        {activeMukando.length > 0 ? (
          <div style={{
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1rem' }}>
              ...
              <span style={{ background: 'rgba(116,140,61,0.1)', color: '#748c3d', fontSize: '0.68rem', fontWeight: '700', padding: '0.2rem 0.7rem', borderRadius: '2rem' }}>
            ...
            {activeMukando.slice(0, 1).map((group) => {
              ...
              return (
                <div key={group.group_id}>
                  <div style={{ fontSize: '1rem', fontWeight: '700', color: '#1c1917', marginBottom: '0.2rem' }}>
                    {group.name}
                  </div>
                  <div style={{ fontSize: '0.78rem', color: '#78716c', marginBottom: '1rem' }}>
                    ...
                    {group.has_received_payout && (
                      <span style={{ marginLeft: '0.5rem', background: 'rgba(116,140,61,0.1)', color: '#748c3d', fontSize: '0.65rem', fontWeight: '700', padding: '0.1rem 0.5rem', borderRadius: '2rem' }}>
                        Received
                      </span>
                    )}
                  </div>
                    ...
                    <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '0.3rem' }}>
                      {Array.from({ length: Math.min(totalMonths, 12) }, (_, i) => (
                        <div key={i} style={{
                          ...
                          background: i < currentMonth ? '#a8845a' : i === currentMonth - 1 ? '#d4af37' : 'rgba(168,132,90,0.2)',
                        }} />
                      ))}
                    </div>
                  </div>
            ...
            <button
              ...
              style={{
                ...
                border: '1.5px solid rgba(168,132,90,0.3)', borderRadius: '1rem',
                color: '#a8845a', fontWeight: '600', fontSize: '0.875rem', cursor: 'pointer',
                display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '0.5rem',
              }}
            >
